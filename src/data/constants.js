...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "Flask",
        image: "https://raw.githubusercontent.com/devicons/devicon/ca28c779441053191ff11710fe24a9e6c23690d6/icons/flask/flask-original.svg",
      },
    ],
  },
  {
    ...
    skills: [
      ...
      {
        name: "Ubuntu",
        image: "https://raw.githubusercontent.com/devicons/devicon/master/icons/ubuntu/ubuntu-plain-wordmark.svg",
      },
      {
        name: "Netlify",
      ...
      {
        name: "Figma",
        image: "https://raw.githubusercontent.com/devicons/devicon/ca28c779441053191ff11710fe24a9e6c23690d6/icons/figma/figma-original.svg",
      },
    ],
  },
];
...
export const experiences = [
  {
    id: 0,
    img: AA,
    role: "UI/UX Frontend Design & Software Engineer Intern",
    company: "Alien Attorney / Orbex Labs",
    date: "July 2024 - Present",
    desc: "During my time with Alien Attorney I have created numerous comprehensive UI/UX design reports with research findings, wireframes, guidelines, and usability test results in order to inform design decisions. In addition I designed a developed the Alien Attorney Website as well as the R & D non-profit sister company, Orbex Labs. I utilized tools such as Figma to improve user flow and engagement. Currently I am on a project called Cyclops where I am designing and developing a dynamic chat interface similiar to ChatGPT for a machine learning / computer vision platform using Python with Flask, HTML/CSS, and Vanilla Javascript. This enables users to have a seamless interaction with the AI.",
    skills: [
      "JavaScript",
      "HTML/CSS",
      "Python",
  ...
  },
  {
    id: 1,
    img: A2Z,
    role: "Frontend/Website Designer and Devolper",
    company: "A2Z MKTG",
    date: "November 2023 - Present",
    desc: "During my time at A2Z I have led development of responsive websites, ensuring seamless cross-device functionality, collaborated on intuitive UI designs, aligning with business goals and enhancing user engagement, utilized HTML5, CSS3, JavaScript, and responsive frameworks for visually appealing web solutions.",
    skills: [
      "JavaScript",
      "HTML/CSS",
      "Figma",
...
export const education = [
  {
    id: 0,
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/University_of_Illinois_at_Chicago_circle_logo.svg/300px-University_of_Illinois_at_Chicago_circle_logo.svg.png",
    school: "University of Illinois at Chicago",
    date: "August 2021 - May 2025",
    desc: "I am currently a senior pursuing a Bachelor's degree in Computer Science with a concentration in Software Engineering at the University of Illinois at Chicago. I enrolled at the University of Illinois at Chicago in the fall of 2021. While there I have taken numerous computer science courses there such as Dara structures, Computer Algorithms, Intro to Machine Learning and many more. In addition, I am a former member of the Society of Automotive Engineers (SAE) and current member of the Polish American Student Association (PASA).",
    degree: "Bachelor of Science, Computer Science - Software Engineering Concentration",
  },
  {
    id: 1,
    img: "https://upload.wikimedia.org/wikipedia/commons/3/38/Mvcclogo.png",
    school: "Moraine Valley Community College",
    date: "May 2022 - August 2023",
    desc: "During the summer and winter break semesters I have used my time off to complete additional classes and tranferred those credits torwads my degree at UIC.",
    degree: "Completed additional general education classes",
  },
...
export const projects = [
  ...
  },
  {
    ...
    date: "October 2022",
    description:
      "This project reads data from a entered file from a selection and displays the data by each frame. The data files are simple .txt files that include a title, label, and the source of the data. Each frame is a group of lines that have the same year, and each individual line in each group is a different record. When presenting the data the graph will update with relevent data for each each frame. This project used multiple classes programmed in C++ that built off one one another. There was a class for individual bars, a class for the bar chart per frame, and finally a class for the bar chart animation.",
    image: BarChart,
    tags: ["C++", "Makefile"],
    category: "backend",
    github: "https://github.com/Abern10/Animated-BarChart",
    webapp: "",
    member: [
      {
        name: "Alexander Bernatowicz",
  ...
  },
  {
    ...
    tags: ["HTML", "CSS", "JavaScript"],
    category: "frontend",
    github: "https://github.com/Abern10/Personal-Website",
    webapp: "https://bernatowiczportfolio.com",
    member: [
      {
        name: "Alexander Bernatowicz",
        img: HeroImg,
